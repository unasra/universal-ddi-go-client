...
// checks if the UserInIdentityV2AccountInIdentityV2Group type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserInIdentityV2AccountInIdentityV2Group{}

// UserInIdentityV2AccountInIdentityV2Group struct for UserInIdentityV2AccountInIdentityV2Group
type UserInIdentityV2AccountInIdentityV2Group struct {
...
type _UserInIdentityV2AccountInIdentityV2Group UserInIdentityV2AccountInIdentityV2Group
...
func NewUserInIdentityV2AccountInIdentityV2Group() *UserInIdentityV2AccountInIdentityV2Group {
	this := UserInIdentityV2AccountInIdentityV2Group{}
	return &this
}
...
func (o UserInIdentityV2AccountInIdentityV2Group) MarshalJSON() ([]byte, error) {
...
func (o UserInIdentityV2AccountInIdentityV2Group) ToMap() (map[string]interface{}, error) {
...
func (o *UserInIdentityV2AccountInIdentityV2Group) UnmarshalJSON(data []byte) (err error) {
	varUserInIdentityV2AccountInIdentityV2Group := _UserInIdentityV2AccountInIdentityV2Group{}

	err = json.Unmarshal(data, &varUserInIdentityV2AccountInIdentityV2Group)

	if err != nil {
		return err
	}

	*o = UserInIdentityV2AccountInIdentityV2Group(varUserInIdentityV2AccountInIdentityV2Group)
...
type NullableUserInIdentityV2AccountInIdentityV2Group struct {
	value *UserInIdentityV2AccountInIdentityV2Group
	isSet bool
}

func (v NullableUserInIdentityV2AccountInIdentityV2Group) Get() *UserInIdentityV2AccountInIdentityV2Group {
	return v.value
}

func (v *NullableUserInIdentityV2AccountInIdentityV2Group) Set(val *UserInIdentityV2AccountInIdentityV2Group) {
	v.value = val
	v.isSet = true
}

func (v NullableUserInIdentityV2AccountInIdentityV2Group) IsSet() bool {
	return v.isSet
}

func (v *NullableUserInIdentityV2AccountInIdentityV2Group) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserInIdentityV2AccountInIdentityV2Group(val *UserInIdentityV2AccountInIdentityV2Group) *NullableUserInIdentityV2AccountInIdentityV2Group {
	return &NullableUserInIdentityV2AccountInIdentityV2Group{value: val, isSet: true}
}

func (v NullableUserInIdentityV2AccountInIdentityV2Group) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserInIdentityV2AccountInIdentityV2Group) UnmarshalJSON(src []byte) error {
	v.isSet = true

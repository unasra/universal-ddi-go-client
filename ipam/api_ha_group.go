...
type HaGroupAPI interface {
	...
	*/
	...
	/*
			ListLinkedHAGroups Retrieve the list of linked HA groups.

			Use this method to retrieve linked HA groups. For a given HA group or hosts, a linked HA group is any
		group that shares a host with it, either directly or transitively through other groups.
		In other words, groups are linked if they can be connected through a chain of shared hosts.
		Only one of HA group or hosts can be given in a request.
		For a given HA group or hosts, this returns, if any are present, __LinkedHAGroup__ objects.

			@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
			@return HaGroupAPIListLinkedHAGroupsRequest
	*/
	ListLinkedHAGroups(ctx context.Context) HaGroupAPIListLinkedHAGroupsRequest

	// ListLinkedHAGroupsExecute executes the request
	//  @return LinkedHAGroupsResponse
	ListLinkedHAGroupsExecute(r HaGroupAPIListLinkedHAGroupsRequest) (*LinkedHAGroupsResponse, *http.Response, error)
	/*
...
type HaGroupAPIListLinkedHAGroupsRequest struct {
	ctx        context.Context
	ApiService HaGroupAPI
	body       *LinkedHAGroupsRequest
}

func (r HaGroupAPIListLinkedHAGroupsRequest) Body(body LinkedHAGroupsRequest) HaGroupAPIListLinkedHAGroupsRequest {
	r.body = &body
	return r
}

func (r HaGroupAPIListLinkedHAGroupsRequest) Execute() (*LinkedHAGroupsResponse, *http.Response, error) {
	return r.ApiService.ListLinkedHAGroupsExecute(r)
}
...
For a given HA group or hosts, this returns, if any are present, __LinkedHAGroup__ objects.
	...
	@return HaGroupAPIListLinkedHAGroupsRequest
*/
func (a *HaGroupAPIService) ListLinkedHAGroups(ctx context.Context) HaGroupAPIListLinkedHAGroupsRequest {
	return HaGroupAPIListLinkedHAGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return LinkedHAGroupsResponse
func (a *HaGroupAPIService) ListLinkedHAGroupsExecute(r HaGroupAPIListLinkedHAGroupsRequest) (*LinkedHAGroupsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []internal.FormFile
		localVarReturnValue *LinkedHAGroupsResponse
	)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(r.ctx, "HaGroupAPIService.ListLinkedHAGroups")
	if err != nil {
		return localVarReturnValue, nil, internal.NewGenericOpenAPIError(err.Error())
	}

	localVarPath := localBasePath + "/dhcp/ha_group/linked_ha_groups"

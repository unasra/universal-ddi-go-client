...
Other parameters are passed through a pointer to a `HaGroupAPICreateRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HaGroupAPIDeleteRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.HaGroupAPI.List(context.Background()).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `HaGroupAPIListRequest` struct via the builder pattern
...
func main() {
	...
	apiClient := ipam.NewAPIClient()
	resp, r, err := apiClient.HaGroupAPI.Read(context.Background(), id).Execute()
	if err != nil {
...
Other parameters are passed through a pointer to a `HaGroupAPIReadRequest` struct via the builder pattern
...
Other parameters are passed through a pointer to a `HaGroupAPIUpdateRequest` struct via the builder pattern

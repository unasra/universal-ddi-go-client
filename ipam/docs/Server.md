...
**DhcpConfig** | Pointer to [**DHCPConfig**](DHCPConfig.md) | The DHCP configuration for the profile. This controls how leases are issued. | [optional] 
...
**InheritanceSources** | Pointer to [**ServerInheritance**](ServerInheritance.md) | The inheritance configuration. | [optional] 

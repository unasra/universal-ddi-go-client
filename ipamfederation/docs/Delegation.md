...
**DelegatedTo** | **string** | The specific IPAM service the delegation was delegated to. In case federated realms are not provided, this field would be used to determine the __Federated_Realm__ the __Delegation__ should be part of. | 
...
**Metadata** | Pointer to **map[string]interface{}** | The metadata for the delegation in JSON format. | [optional] 
...
**Region** | Pointer to **string** | The region where the delegation is located. | [optional] 
**Tags** | Pointer to **map[string]interface{}** | The tags for the delegation in JSON format. | [optional] 
**UpdatedAt** | Pointer to **time.Time** | Time when the object has been updated. Equals to _created_at_ if not updated after creation. | [optional] [readonly] 
**Utilization** | Pointer to **int64** | The IP address utilization percentage of the object _federation/delegation_. | [optional] [readonly] 
